...
2. **Preguntas** — clarifica visión, alcance de la v1, restricciones técnicas, integraciones externas, orden de valor y riesgos de arquitectura.
3. **Descomposición** — parte el proyecto en ítems del tamaño de una spec (resolubles en horas, no días), con dependencias y orden explícitos.
4. **Guardado** — escribe `specs/00-roadmap.md` con estado `Planning`.
...
Un roadmap con: visión en una o dos oraciones, alcance in/out de la v1, arquitectura de alto nivel, y la lista ordenada de specs candidatas (cada una con objetivo, dependencias, tamaño relativo y estado).
